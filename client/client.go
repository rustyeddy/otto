...
// get is a helper method that performs an HTTP GET request to the specified path
// and decodes the JSON response into the provided result interface.
// This reduces code duplication across API methods.
